...
;(function($) {
	...
	$.slidebars = function(options) {
		...
		windowHeight = $(window).height(), // Get height of window.
		...
		function css() {
			...
			$site.css('minHeight', $('body').height() - 50 + 'px'); // Set minimum height of the site to the minimum height of the body.
		...
		$(window).resize(function() {
			...
			var resizedWindowHeight = $(window).height(); // Get resized window width.
			if (windowWidth !== resizedWindowWidth || windowHeight !== resizedWindowHeight) { // Window was actually resized.
